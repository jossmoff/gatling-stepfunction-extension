...
class FakeEventLoop extends EventLoop {
  ...
  override def parent(): EventLoopGroup =
    throw new UnsupportedOperationException
  override def next(): EventLoop = throw new UnsupportedOperationException
  override def register(channel: Channel): ChannelFuture =
    throw new UnsupportedOperationException
  ...
  override def newPromise[V](): Promise[V] =
    throw new UnsupportedOperationException
  override def newProgressivePromise[V](): ProgressivePromise[V] =
    throw new UnsupportedOperationException
  override def newSucceededFuture[V](result: V): NFuture[V] =
    throw new UnsupportedOperationException
  override def newFailedFuture[V](cause: Throwable): NFuture[V] =
    throw new UnsupportedOperationException
  override def isShuttingDown: Boolean = throw new UnsupportedOperationException
  override def shutdownGracefully(
      quietPeriod: Long,
      timeout: Long,
      unit: juc.TimeUnit
  ...
  override def iterator(): ju.Iterator[EventExecutor] =
    throw new UnsupportedOperationException
  override def submit(task: Runnable): NFuture[_] =
    throw new UnsupportedOperationException
  override def submit[T](task: Runnable, result: T): NFuture[T] =
    throw new UnsupportedOperationException
  override def submit[T](task: juc.Callable[T]): NFuture[T] =
    throw new UnsupportedOperationException
  override def schedule[V](
      callable: juc.Callable[V],
      delay: Long,
      unit: juc.TimeUnit
  ): ScheduledFuture[V] = throw new UnsupportedOperationException
  ...
  override def awaitTermination(timeout: Long, unit: juc.TimeUnit): Boolean =
    throw new UnsupportedOperationException
  override def invokeAll[T](
      tasks: ju.Collection[_ <: juc.Callable[T]]
  ): ju.List[juc.Future[T]] = throw new UnsupportedOperationException
  override def invokeAll[T](
      tasks: ju.Collection[_ <: juc.Callable[T]],
      timeout: Long,
      unit: juc.TimeUnit
    ...
    throw new UnsupportedOperationException
  override def invokeAny[T](tasks: ju.Collection[_ <: juc.Callable[T]]): T =
    throw new UnsupportedOperationException
